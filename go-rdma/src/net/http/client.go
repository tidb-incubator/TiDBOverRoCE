...
func Get(url string) (resp *Response, err error) {
	rdma.DPrintf("rdma debug: http client Get()")
...
func (c *Client) Do(req *Request) (*Response, error) {
	rdma.DPrintf("rdma debug: http client Do()")
	return c.do(req)
}
...
func (b *cancelTimerBody) Read(p []byte) (n int, err error) {
	rdma.DPrintf("rdma debug: http client cancelTimerBody Read()")
...
func (b *cancelTimerBody) Close() error {
	rdma.DPrintf("rdma debug: http client cancelTimerBody Close()")
	err := b.rc.Close()
	b.stop()
	return err
}
